...
<?php require 'news_input_modal.php'; ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15">
				...
				<button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#newsInput">News Input  </button>

				</div></div>
            <h4 class="page-title">Raw News</h4>
        </div>
    </div>
...
<?php include 'news_raw_modal.php'; 
