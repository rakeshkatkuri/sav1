    ...
    <div class="col-sm-12">
        <div class="card-box">
            ...
            <div class="row m-t-50">
                ...
                <!-- Pagers -->
                <div class="col-md-6 m-t-20 m-t-sm-40">
                    <h4 class="m-t-0 header-title">Pagers</h4>
                    <p class="text-muted m-b-30 font-13">
                        Quick previous and next links for simple pagination implementations with light markup and styles.
                    </p>

                    <div>
                        <h6 class="m-b-5">Default</h6>
                        <p class="text-muted font-13">
                        ...
                        <h6 class="m-b-5">Aligned Links</h6>
                        <p class="text-muted font-13">
                        ...
                        <h6 class="m-b-5">Optional Disabled State</h6>
                        <p class="text-muted font-13">
