...
<?php require 'includes/header_end.php'; ?>
    ...
    <div class="row">
        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
            <div class="card-box tilebox-two">
                <a href="#" class="btn btn-sm btn-custom waves-effect waves-light pull-xs-right">View</a>
        ...
        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
            <div class="card-box tilebox-two">
                ...
                <progress class="progress progress-striped progress-xs progress-warning m-b-0" value="45" max="100">45%
                </progress>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
            <div class="card-box tilebox-two">
                ...
                <progress class="progress progress-striped progress-xs progress-success m-b-0" value="70" max="100">70%
                </progress>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
            <div class="card-box tilebox-two">
                ...
                <progress class="progress progress-striped progress-xs progress-danger m-b-0" value="95" max="100">95%
                </progress>
            </div>
        </div>
            ...
            <div class="card-box widget-user">
                <div>
                    ...
                    <div class="wid-u-info">
                        ...
                        <p class="text-muted m-b-0 font-13">coderthemes@gmail.com</p>
