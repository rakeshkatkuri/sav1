        ...
        <div class="card-box">
            ...
            <div class="row m-t-50">
                <div class="col-md-6 m-t-20">
                    ...
                    <div class="button-list">
                        <button type="button" class="btn btn-primary-outline waves-effect waves-light">Primary</button>
                        <button type="button" class="btn btn-secondary-outline waves-effect">Secondary</button>
                        <button type="button" class="btn btn-success-outline waves-effect waves-light">Success</button>
                        <button type="button" class="btn btn-info-outline waves-effect waves-light">Info</button>
                        <button type="button" class="btn btn-warning-outline waves-effect waves-light">Warning</button>
                        <button type="button" class="btn btn-danger-outline waves-effect waves-light">Danger</button>
                        <button type="button" class="btn btn-dark-outline waves-effect waves-light">Dark</button>
                        <button type="button" class="btn btn-purple-outline waves-effect waves-light">Purple</button>
                        <button type="button" class="btn btn-pink-outline waves-effect waves-light">Pink</button>
                    </div>
                </div>
                ...
                <div class="col-md-6 m-t-20">
                    ...
                    <div class="button-list">
                        <button type="button" class="btn btn-primary-outline btn-rounded waves-effect waves-light">Primary</button>
                        <button type="button" class="btn btn-secondary-outline btn-rounded waves-effect">Secondary</button>
                        <button type="button" class="btn btn-success-outline btn-rounded waves-effect waves-light">Success</button>
                        <button type="button" class="btn btn-info-outline btn-rounded waves-effect waves-light">Info</button>
                        <button type="button" class="btn btn-warning-outline btn-rounded waves-effect waves-light">Warning</button>
                        <button type="button" class="btn btn-danger-outline btn-rounded waves-effect waves-light">Danger</button>
                        <button type="button" class="btn btn-dark-outline btn-rounded waves-effect waves-light">Dark</button>
                        <button type="button" class="btn btn-purple-outline btn-rounded waves-effect waves-light">Purple</button>
                        <button type="button" class="btn btn-pink-outline btn-rounded waves-effect waves-light">Pink</button>
                    </div>
